...
const icons = {
  pickup : "https://ik.imagekit.io/imashish/assets/hamburger_P9jWmanPo.svg",
  drop : "https://ik.imagekit.io/imashish/assets/house_fVFfVu7ZRg.svg"
};
...
const Home = () => {
  ...
  const generateNodes = (path) => {
    return path.map(item => ({ id: item, svg: item.includes('H') ? icons.drop : icons.pickup }))
  }
